...
int main (int argc, char* argv[])
{
	...
	printf ("Bash Colors TXT HIGH:\t%s Black %s Red %s Green %s Yellow %s Blue %s Purple %s Cyan %s White %s Reset!\n", BC_TXT_HGH_BLACK, BC_TXT_HGH_RED, BC_TXT_HGH_GREEN, BC_TXT_HGH_YELLOW, BC_TXT_HGH_BLUE, BC_TXT_HGH_PURPLE, BC_TXT_HGH_CYAN, BC_TXT_HGH_WHITE, BC_TXT_RST);
	...
	printf ("Bash Colors BLD HIGH:\t%s Black %s Red %s Green %s Yellow %s Blue %s Purple %s Cyan %s White %s Reset!\n", BC_BLD_HGH_BLACK, BC_BLD_HGH_RED, BC_BLD_HGH_GREEN, BC_BLD_HGH_YELLOW, BC_BLD_HGH_BLUE, BC_BLD_HGH_PURPLE, BC_BLD_HGH_CYAN, BC_BLD_HGH_WHITE, BC_TXT_RST);
	...
	printf ("Bash Colors BAK HIGH:\t%s Black %s Red %s Green %s Yellow %s Blue %s Purple %s Cyan %s White %s Reset!\n", BC_BAK_HGH_BLACK, BC_BAK_HGH_RED, BC_BAK_HGH_GREEN, BC_BAK_HGH_YELLOW, BC_BAK_HGH_BLUE, BC_BAK_HGH_PURPLE, BC_BAK_HGH_CYAN, BC_BAK_HGH_WHITE, BC_TXT_RST);
